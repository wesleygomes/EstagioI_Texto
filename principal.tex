...
%OK!!
Desenvolvimento de aplicações móvies é uma área que está em ascensão no âmbito mundial, com isso muitos serviços virão para aproveitar o conceito de mobilidade e acessibilidade. Os dispositivos móveis são os responsáveis por este crescimento, pois eles estão cada vez mais presentes na vida das pessoas. Neste trabalho foi desenvolvido uma análise tecinas em 3 software voltado para o ramo de pet shop, onde será descrito uma tabela com os requisitos funcionais e nao-funcionais e cada software e suas principais funcionalidades, assim identificando falhas, que poderão ser corrigidas e melhorandas, e os requisitos proposto para ser desenvolvido em um novo software proposto para desenvolvimento futuro.
...
\chapter*{Pesquisa Bibliografica}
